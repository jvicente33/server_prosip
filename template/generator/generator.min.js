...
!(function() {
  ...
  var a,
    ...
    f =
      '?utm_source=generator&utm_medium=template&utm_campaign=invoicebus_templates',
    ...
    l = function() {
      ...
      return (
        (a.innerHTML =
          'Oops sorry, the template cannot be rendered. Mind checking your internet connection?'),
        a.setAttribute(
          'style',
          'position:fixed; top:0px; left:0px; background:#f75520; color:white; text-align:center; width:100%; padding:10px 0; font:normal 14px/1.4em "Open Sans", Arial, Sans-serif; border-bottom:3px solid #fff; box-shadow:0px 0px 10px 2px #aaa;'
        ),
    ...
    u = function() {
      var a = setInterval(function() {
        for (var b = 0; b < document.styleSheets.length; b++)
          if (
            -1 != document.styleSheets[b].href.indexOf('generator' + h + '.css')
          ) {
      ...
      $(document)
        ...
        $('*').each(function() {
          for (var a = 0; a < this.attributes.length; a++)
            -1 == w.indexOf(this.attributes[a].name) &&
        ...
        $(document)
          ...
          .each(function() {
            0 ===
              $(this)
                .attr('href')
                .indexOf('javascript') && $(this).removeAttr('href');
          });
    },
    y = function() {
    ...
    z = function() {
      ...
      return (
        a.indexOf('Safari/') > -1 &&
        !(a.indexOf('Chrome/') > -1 || a.indexOf('OPR/') > -1)
      );
    },
    A = function(a) {
      return a
    ...
    E = function() {
      ...
      D
        ? (a.addClass('ib_editable_outline ib_stop_animate'),
          $('.ib_highlight_editable').addClass('active active_hover'))
        : (a.removeClass('ib_editable_outline'),
    ...
    F = {
      en: {
        ...
        invoice: 'Invoice',
        print_info:
          'This command is also used to save<br/>the invoice as PDF. See FAQ for more info.',
        highlight: 'Highlight',
        highlight_info: 'Highlight editable fields',
        open_data: 'Open',
        open_data_info:
          'Open already saved data.<br>The file must be loaded from the<br>same location as template.html',
        text_format_alert: 'Please upload text file. Supported format is .txt',
        save_state: 'Save State',
        save_online: 'Save Online',
        save_info:
          'Save current invoice data such as<br/>company address, logo, etc., for future re-use',
        online: 'Online',
        online_info:
          "You'll be taken to the Invoicebus website<br>to save this invoice online",
        ...
        logo_upload_tooltip:
          "Drop image or click to upload your logo (max 2MB).<br>For better print resolution use larger image,<br>as it's automatically scaled down.",
        drop_logo: 'Drop your logo here',
        remove_logo: 'Remove logo',
        image_format_alert:
          'Please upload image file. Supported formats are .png, .jpg ang .gif',
      ...
      de: {
        ...
        invoice: 'Rechnung',
        print_info:
          'Dieser befehl wird auch zu speichern<br/>die rechnung als PDF verwendet. Siehe FAQ für weitere informationen.',
        highlight: 'Markieren',
        highlight_info: 'Markieren sie editierbaren felder',
        open_data: 'Öffnen',
        open_data_info:
          'Öffnen sie bereits gespeicherte daten.<br>Die datei muss von demselben speicherort<br>wie template.html geladen werden',
        text_format_alert:
          'Bitte laden sie die textdatei hoch. Das unterstützte format ist .txt',
        save_state: 'Sicherer Staat',
        save_online: 'Speichern Online',
        save_info:
          'Speichern des aktuellen rechnungsdaten wie<br/>firmenadresse, logo usw. Für zukünftige nutzung',
        online: 'Online',
        online_info:
          'Sie werden auf Invoicebus website<br>genommen werden, um diese rechnung online zu speichern',
        ...
        logo_upload_tooltip:
          'Drop-bild oder klicken sie ihr logo (max 2 MB) hochladen.<br>Für eine bessere druckauflösung größeres bild zu verwenden,<br>wie es automatisch verkleinert wird.',
        drop_logo: 'Lassen sie ihr logo hier',
        remove_logo: 'Logo entfernen',
        image_format_alert:
          'Bitte laden sie die bilddatei hoch. Unterstützte formate sind .png, .jpg und .gif',
        ...
        company_city_zip_state_tooltip:
          'Geben sie unternehmens zip, stadt und land',
        company_phone_fax_tooltip: 'Geben sie unternehmens vertrag handys',
        company_email_web_tooltip:
          'Geben sie unternehmens web-adresse und e-mail-adresse',
      ...
      es: {
        ...
        invoice: 'Factura',
        print_info:
          'Este comando tambien se utiliza para guardar<br/>la factura en PDF. Ve FAQ para mas informacion.',
        highlight: 'Destaca',
        highlight_info: 'Destaca los campos modificables',
        open_data: 'Abierto',
        open_data_info:
          'Abrir datos ya guardados.<br>El archivo debe ser cargado desde la<br>misma ubicación que template.html',
        text_format_alert:
          'Por favor, sube archivo de texto. Formato soportado es .txt',
        save_state: 'Guardar Estado',
        save_online: 'Guardar Online',
        save_info:
          'Guarda los datos de la factura actuales como<br/>direccion de la empresa, logotipo, etc., por una reutilizacion futura',
        online: 'Online',
        online_info:
          'Seras llevado a la pagina Invoicebus web<br>para guardar esta factura online',
        account_info:
          'Necesitas una cuenta Invoicebus para guardar esta factura',
        about: 'Sobre',
        got_it: 'OK, entendido',
        ...
        logo_upload_tooltip:
          'Caiga imagen o haga clic para cargar tu logotipo (max 2MB).<br>Para obtener la mejor resolucion de impresion utiliza la imagen grande,<br>como se reducen de forma automatica.',
        drop_logo: 'Arrastre tu logotipo aqui',
        remove_logo: 'Elimina tu logotipo',
        image_format_alert:
          'Por favor, cargar el archivo de imagen. Los formatos soportados son .png, .jpg .gif ang',
        image_too_big_alert:
        ...
        company_city_zip_state_tooltip:
          'Rellena con el codigo postal, la ciudad y el pais de la empresa',
        company_phone_fax_tooltip:
          'Rellena con el telefono de contacto de la empresa',
        company_email_web_tooltip:
          'Rellena con el e-mail y la pagina web de la empresa',
        ...
        due_date_label_tooltip:
          'Introduce la etiqueta de la fecha de vencimiento de la factura',
        ...
        client_city_zip_state_tooltip:
          'Introduce el codigo postas, la ciudad y el pais del cliente',
        ...
        item_line_total_label_tooltip:
          'Introduce el encabezado de los totales de linea',
        item_row_number_tooltip: '',
      ...
      it: {
        ...
        invoice: 'Fattura',
        print_info:
          'Questo comando e anche usato per salvare<br/>la fattura come PDF. Vedi FAQ per piu informazioni.',
        highlight: 'Evidenzia',
        highlight_info: 'Seleziona i campi modificabili',
        open_data: 'Aperto',
        open_data_info:
          'Aprire i dati già salvati.<br>Il file deve essere caricato dalla<br>stessa posizione come template.html',
        text_format_alert:
          'Si prega di caricare file di testo. formato supportato è .txt',
        save_state: 'Salva Stato Della',
        save_online: 'Salva Online',
        save_info:
          "Salva i dati di fattura attuali come<br/>indirizzo dell'azienda, logo, ecc., per un riutilizzo futuro",
        online: 'Online',
        online_info:
          'Sarai portato alla pagina web di Invoicebus<br>per salvare questa fattura online',
        account_info:
          'Hai bisogno di un account Invoicebus per salvare questa fattura',
        about: 'Attorno',
        got_it: 'OK, capito',
        ...
        logo_upload_tooltip:
          "Rilascia immagine o clicca per caricare il tuo logo (max 2MB).<br>Per migliore risoluzione di stampa usa immagine grande,<br>com'e scalato automaticamente.",
        drop_logo: 'Rilascia il tuo logo qui',
        remove_logo: 'Rimuovere logo',
        image_format_alert:
          'Si prega di caricare file di immagine. I formati supportati sono .png, .jpg ang .gif',
        image_too_big_alert:
          'File troppo grande, la dimensione massima è di 2MB',
        ...
        company_city_zip_state_tooltip:
          "Inserisci il cap, la citta e il Paese dove si trova l'azienda",
        company_phone_fax_tooltip:
          "Inserisci i telefoni di contatto dell'azienda",
        company_email_web_tooltip:
          "Inserisci l'e-mail e la pagina web dell'azienda",
        ...
        due_date_label_tooltip:
          "Inserisci l'etichetta sulla data di scadenza della fattura",
        due_date_tooltip: 'Seleziona data di scadenza della fattura',
        currency_label_tooltip:
          "Inserisci l'etichetta della valuta della fattura",
        ...
        client_city_zip_state_tooltip:
          'Inserisci il cap, la citta e il Paese del cliente',
        ...
        item_line_total_label_tooltip:
          'Inserisci intestazione del totale di linea',
        item_row_number_tooltip: '',
      ...
      fr: {
        ...
        invoice: 'Facture',
        print_info:
          "Cette commande est aussi utilisée pour sauvegarder<br/>la facture sous forme PDF. Consultez FAQ pour plus d'infos.",
        highlight: 'Marque',
        highlight_info: 'Mettre en relief les champs modifiables',
        open_data: 'Ouvrir',
        open_data_info:
          'Ouvrez les données déjà enregistrées.<br>Le fichier doit être chargé à partir<br>du même emplacement que template.html',
        text_format_alert:
          "S'il vous plaît télécharger le fichier texte. Format pris en charge est .txt",
        save_state: "Enregistrer L'état",
        save_online: 'Enregistrer en Ligne',
        save_info:
          "Enregistrer les données actuelles de la facture telles que<br/>adresse de l'entreprise, logo, etc., pour un futur réemploi",
        online: 'En ligne',
        online_info:
          'Vous serez réorienté vers le site de Invoicebus website<br>sauvegarder cette facture en ligne',
        account_info:
          "Vous avez besoin d'un compte Invoicebus pour sauvegarder cette facture",
        about: 'Pour',
        faq: 'FAQ',
        got_it: 'OK, compris',
        ...
        logo_upload_tooltip:
          "Laisser tomber l'image ou cliquer pour télécharger votre logo (max 2MB).<br>Pour une meilleure résolution d'impression utiliser un image plus large,<br>comme c'est automatiquement réduit.",
        drop_logo: 'Laisser tomber votre logo ici',
        remove_logo: 'Supprimer logo',
        image_format_alert:
          "S'il vous plaît télécharger le fichier d'image. Les formats supportés sont .png, .jpg ang .gif",
        image_too_big_alert:
          'Fichier trop grand, la taille maximale est de 2MB',
        ...
        company_city_zip_state_tooltip:
          'Entrer le code postale, la ville et le pays de votre entreprise',
        company_phone_fax_tooltip:
          'Entrer les numéros de téléphone de votre entreprise',
        company_email_web_tooltip:
          'Entrer le site internet et le courriel de votre entreprise',
        ...
        due_date_label_tooltip:
          "Entrer l'étiquette de la date limite de la facture",
        due_date_tooltip: 'Sélectionner la date limite de la facture',
        currency_label_tooltip:
          "Entrer l'étiquette de la monnaie de la facture",
        ...
        client_city_zip_state_tooltip:
          'Enter la ville,le code postal et le pays du client',
        client_phone_fax_tooltip:
          'Entrer le numéro de téléphone et de fax du client',
    ...
    G = function() {
      var a = '';
      (a += '<select class="ib_pull_right ib_lang_select">'),
        (a +=
          '<option value="" selected="selected" title="These are the data and language saved in your \'data.txt\' file">Default</option>'),
        (a += '<option value="" disabled="disabled">------------</option>');
      for (var b in F)
        a +=
          '<option value="' +
          b +
    ...
    H = function() {
      $('head').prepend(
        ...
        $(document.body)
          .before(
            $(
              '<ib-span class="ib_invoice_commands_wrap"><ib-span class="ib_invoice_commands"><ib-span id="ib-print-btn" class="ib_default_button" data-tooltip="tooltip" data-placement="bottom" title="' +
                F[Ib].print_info +
                '"><i class="fa fa-print"></i><span class="ib_hide_xsmall"> ' +
                F[Ib].print +
                '</span></ib-span><ib-span class="ib_default_button ib_highlight_editable" data-tooltip="tooltip" data-placement="bottom" title="' 
            )
          )
          .after(
            $()
        ...
        $('.ib_lang_select').val(Jb),
        $('.ib_lang_select').change(function() {
          var a = $(this).val(),
            b = window.location.href;
          b.indexOf('lang=') > -1
            ? (b = b.replace(/lang=.{2}/, 'lang=' + a))
            : (b += b.indexOf('?') > -1 ? '&lang=' + a : '?lang=' + a),
            a || (b = window.location.origin + window.location.pathname),
            (window.location = b);
        }),
        $(document).scroll(function() {
          ...
          0 === document.documentElement.scrollTop
            ...
            : $('.ib_invoice_commands_wrap').hasClass('ib_commands_shadow') ||
              $('.ib_invoice_commands_wrap').addClass('ib_commands_shadow');
        }),
        $(document.body).after(
          $()
        ),
        JSON.parse(a.invoicebus_fineprint) ||
          $('.ib_invoicebus_fineprint').css('visibility', 'hidden'),
        $('.ib_save_online').click(Eb),
        $('[data-iterate="item"]:last').after(
          $()
        ),
        $('.ib_add_new_row_link').click(function(a) {
          mb(this, a);
        }),
        $('.ib_show_hide_columns_link').after(
          $(
            '<ib-span class="ib_show_hide_columns"><ib-span><input type="checkbox" value="item_row_number" /><ib-span>' +
              F[Ib].row_number +
              '</ib-span></ib-span><ib-span><input type="checkbox" value="item_description" /><ib-span>' +
              F[Ib].description +
              '</ib-span></ib-span><ib-span><input type="checkbox" value="item_quantity" /><ib-span>' +
              F[Ib].quantity +
              '</ib-span></ib-span><ib-span><input type="checkbox" value="item_price" /><ib-span>' +
              F[Ib].price +
              '</ib-span></ib-span><ib-span><input type="checkbox" value="item_discount" /><ib-span>' +
              F[Ib].discount +
              '</ib-span></ib-span><ib-span><input type="checkbox" value="item_tax" /><ib-span>' +
              F[Ib].tax +
              '</ib-span></ib-span><ib-span><input type="checkbox" value="item_line_total" /><ib-span>' +
              F[Ib].line_total +
              '</ib-span></ib-span></ib-span>'
          )
        ),
        $('.ib_show_hide_columns_link, .ib_show_hide_columns').hover(
          function() {
        ...
        $('.ib_show_hide_columns > ib-span > input:checkbox').change(
          function() {
            ...
            'item_row_number' == a
              ? $(
                  '[data-ibcl-id="' + a + '_label"], [data-ibcl-id="' + a + '"]'
                ).toggleClass('ib_hide_column', !b)
              : ($(
                  '[data-ibcl-id="' + a + '_label"], [data-ibcl-id="' + a + '"]'
                ).toggle(b),
                $(
                  ...
                  .parent('td')
                  .toggle(b),
                $('[data-ibcl-id="' + a + '_label"]').hasClass(
                  'ibcl_ie_contenteditable'
                ) &&
                  $('[data-ibcl-id="' + a + '_label"]')
                    .parent()
                    .toggle(b),
                $('[data-ibcl-id="' + a + '"]').hasClass(
                  'ibcl_ie_contenteditable'
                ) &&
                  $('[data-ibcl-id="' + a + '"]')
                    .parent()
      ...
      for (var b = 0; b < a.default_columns.length; b++)
        $('input[type="checkbox"][value="' + a.default_columns[b] + '"]').prop(
          'checked',
          !0
        );
      $('.ib_show_hide_columns > ib-span > input:checkbox').change();
    ...
    L = function() {
      if (!(J > o)) {
        if ('undefined' != typeof ib_invoice_data) {
          'function' == typeof ib_invoice_data &&
            (ib_invoice_data = ib_parseData(
              ib_multiline.stripIndent(ib_invoice_data)
            ));
          for (var b in ib_invoice_data)
            'undefined' == typeof a[b] &&
              (a[b] = {
                ...
                tooltip:
                  ...
                  b
                    .replace(
                      /{(document|client)_custom_([a-zA-Z0-9_]+)}/gi,
                      '$1 $2'
                    )
                    .replace(/_/g, ' ')
              }),
              'undefined' != typeof a[b].default_text
                ? (a[b].default_text = ib_invoice_data[b])
                : (a[b] = ib_invoice_data[b]);
          (ub = ib_invoice_data.currency_position || 'left'),
            (vb = ib_invoice_data.show_currency || !0),
            (wb = ib_invoice_data.number_format || '0,000.00'),
            wb &&
              ((xb = wb[wb.length - 3]),
              (yb = wb[1]),
              isNaN(parseInt(yb)) || (yb = '')),
            (tb = $(sb).map(function(b, c) {
              return c.code == a['{currency}'].default_text ? c.symbol : void 0;
            })[0]),
            (Ib = ib_invoice_data.lang || Jb || 'en'),
            Kb && (Ib = Jb || 'en');
          var c = document.createElement('script');
          (c.onload = function() {
            var a = ib_multiline.stripIndent(ib_save_state_data),
              b =
                '<ib-div id="ib_saveCurrentStateModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="saveStateModal" aria-hidden="true"><ib-div class="modal-dialog"><ib-div class="modal-content"><ib-div class="modal-header"><ib-span type="button" class="close" data-dismiss="modal"><ib-span aria-hidden="true">&times;</ib-span></ib-span><ib-div class="modal-title" id="saveStateModal">' +
                F[Ib].save_state +
                '</ib-div></ib-div><ib-div class="modal-body"><ib-div class="ib_how_to_container">' +
                a +
                '</ib-div></ib-div></ib-div></ib-div></ib-div>';
            $(document.body).after($(b)),
              $('#ib-save-data-btn').click(function() {
                if (z()) {
                  var a = Fb();
                  $('#ib-save-current-data').attr(
                    'href',
                    'data:text/plain;charset=UTF-8,' + encodeURIComponent(a)
                  ),
              ...
              $('#ib-save-current-data').click(function() {
                ...
                if (y()) {
                  var b =
                    ib_download_data_frame.document ||
                    ib_download_data_frame.contentDocument ||
                    ib_download_data_frame.contentWindow.document;
                  b.open('text/html', 'replace'),
                    ...
                    b.execCommand('SaveAs', !0, 'data.txt');
                } else $(this).attr('href', 'data:text/plain;charset=UTF-8,' + encodeURIComponent(a));
              });
          }),
            (c.src = i + 'docs/save-state/save-state-' + (Ib || 'en') + '.js'),
            document.body.appendChild(c),
            (c = document.createElement('script')),
            (c.onload = function() {
              var a = ib_multiline.stripIndent(ib_how_to_data),
                b =
                  '<ib-div id="ib_howToModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="howToModal" aria-hidden="true"><ib-div class="modal-dialog"><ib-div class="modal-content"><ib-div class="modal-header"><ib-span type="button" class="close" data-dismiss="modal"><ib-span aria-hidden="true">&times;</ib-span></ib-span><ib-div class="modal-title" id="howToModal">' +
                  F[Ib].about +
                  '</ib-div></ib-div><ib-div class="modal-body"><ib-div class="ib_how_to_container">' +
                  a +
                  '</ib-div></ib-div><ib-div class="modal-footer"><ib-span class="ib_default_button" data-dismiss="modal">' +
                  F[Ib].got_it +
                  '</ib-span></ib-div></ib-div></ib-div></ib-div>';
              $(document.body).after($(b));
            }),
            (c.src = i + 'docs/how-to/how-to-' + (Ib || 'en') + '.js'),
            document.body.appendChild(c);
          for (b in a)
            'undefined' != typeof a[b].tooltip &&
              (a[b].tooltip = F[Ib][b.substring(1, b.length - 1) + '_tooltip']);
        } else
          setTimeout(function() {
            L();
          }, m);
    ...
    N = function() {
      O('{company_name}'),
        ...
        O('{payment_info4}'),
        O('{issue_date_label}'),
        O('{issue_date}', !0, { 'data-date': eb }),
        O('{net_term_label}'),
        O('{net_term}'),
        O('{due_date_label}'),
        O('{due_date}', !0, { 'data-date': fb }),
        O('{currency_label}'),
        O('{currency}'),
        O('{po_number_label}'),
        O('{po_number}'),
        ...
        O('{client_name}'),
        O('{client_address}'),
        O('{client_city_zip_state}'),
        O('{client_phone_fax}'),
        O('{client_email}'),
        O('{client_other}'),
        O('{invoice_title}'),
        O('{invoice_number}'),
        O('{item_row_number_label}', !0),
        O('{item_description_label}'),
        O('{item_quantity_label}'),
        O('{item_price_label}'),
        O('{item_discount_label}'),
        O('{item_tax_label}'),
        O('{item_line_total_label}'),
        O('{item_row_number}', !0),
        O('{item_description}'),
        O('{item_quantity}'),
        O('{item_price}'),
        ...
        O('{item_tax}'),
        O('{item_line_total}', !0),
        O('{amount_subtotal_label}'),
        O('{amount_subtotal}', !0),
        O('{tax_name}'),
        O('{tax_value}', !0),
        O('{amount_total_label}'),
        O('{amount_total}', !0),
        O('{amount_paid_label}'),
        O('{amount_paid}'),
        O('{amount_due_label}'),
        ...
        $('*')
          .filter(function() {
            var a = $(this);
            return (
              (/{document_custom_[a-zA-Z0-9_]+}/.test(a.text()) ||
                /{client_custom_[a-zA-Z0-9_]+}/.test(a.text())) &&
              0 === a.children().length &&
              3 == a.prop('firstChild').nodeType
            );
          })
          .each(function(b, c) {
            var d = $(c).text();
    ...
    O = function(b, c, d) {
      for (
        var e = b.substring(1, b.length - 1),
          f = 'TABLE,COL,COLGROUP,TBODY,TD,TFOOT,TH,THEAD,TR'.split(','),
          g = $('*:contains("' + b + '")'),
          h = 0;
        h < g.length;
        h++
        ...
        if (
          0 === $(g[h]).children().length &&
          3 == $(g[h]).prop('firstChild').nodeType
        ) {
          var i = $(g[h]);
          if (y() && f.indexOf(i.prop('tagName')) > -1 && !c) {
            var j = $(
              '<ib-span class="ibcl_ie_contenteditable" contenteditable="true"></ib-span>'
            );
            i.html(j), (i = j);
          }
          i
            ...
            .attr('title', a[b].tooltip)
            .html(a[b].default_text),
            d && i.attr(d),
    ...
    Y = function() {
      ...
      $(document).bind('drop dragover', function(a) {
        ...
        b.after(
          $(
            '<ib-div class="ib_remove_logo_overlay" data-tooltip="tooltip" data-placement="top"><ib-span class="ib_remove_logo" title="' +
              F[Ib].remove_logo +
              '"><i class="fa fa-times-circle"></i></ib-span></ib-div>'
          ).hover(
            function() {},
            function() {
        ...
        setTimeout(function() {
          (T = $('[data-logo="company_logo"]').width()),
            (U = $('[data-logo="company_logo"]').height()),
            (S = T / U),
            T > U ? (R *= 1 / S) : (Q *= S),
            b.hide().before(
              $(
                '<ib-span class="ib_drop_zone" data-tooltip="tooltip" data-placement="top" title="' +
                  F[Ib].logo_upload_tooltip +
                  '"><ib-span>' +
                  F[Ib].drop_logo +
                  '<br /><ib-span>(' +
                  T +
                  ' x ' +
                  U +
                  'px)</ib-span><input type="file" accept="image/*" class="ib_drop_logo" /></ib-span></ib-span>'
              )
                .width(T)
                .height(U)
            ),
            $('.ib_drop_zone')
              ...
              .bind('dragover', f)
              .bind('drop', c),
            $('input.ib_drop_logo').change(function(a) {
              (a.originalEvent.dataTransfer = { files: $(this).prop('files') }),
                c(a);
            }),
            setTimeout(function() {
              a['{company_logo}'] &&
                /^data:image\/.+;base64/.test(a['{company_logo}']) &&
                (b
                  .attr('src', a['{company_logo}'])
                  .css('display', 'block')
                  .hide()
                  .show(),
                $('.ib_logo_base64').val(
                  $('[data-logo="company_logo"]').attr('src')
                ),
                $('.ib_drop_zone').hide());
            }, 100);
        }, 100);
      var c = function(a) {
          ...
          if (d) {
            if (!d.type.match(/image.*/))
              return void alert(F[Ib].image_format_alert);
    ...
    Z = function() {
      ...
      for (
        'undefined' != typeof ib_invoice_data &&
          'undefined' != typeof ib_invoice_data.items &&
          (a.items = ib_invoice_data.items),
          e < a.items.length && (e = a.items.length);
        e > d;
    ...
    ab = function(a, b) {
      for (var c = 0; c < a.length; c++)
        if (
          ((tax_row = $(a[c]).find(
            '[data-ib-value="' + b.getFormatedNumber() + '"]'
          )),
          tax_row.length)
        )
          return c;
    ...
    bb = function(a) {
      return a
        ? $('[data-iterate="tax"]:visible')
            .find('[data-ib-value="' + a.toString().getFormatedNumber() + '"]')
            .closest('[data-iterate="tax"]')
            .find('[data-ibcl-id="tax_name"]')
            .text()
            .replace(/:/gi, '')
        : '';
    };
  (String.prototype.insertString = function(a, b) {
      ...
      if (this) {
        ...
        for (
          ' ' == yb && (e = '&#8239;'),
            c = c.replace(/\./g, xb),
            b = 0,
            a = c.lastIndexOf(xb) - 1;
          a >= 0;
          a--
        )
          2 > b ? b++ : ((b = 0), (c = c.insertString(e, a)));
    ...
    (Number.prototype.toFixed = function(a) {
      a || (a = 0);
      var b = (+(
        Math.round(+(this.toString() + 'e' + a)).toString() +
        'e' +
        -a
      )).toString();
      -1 == b.indexOf('.') && a > 0 && (b += '.');
      for (var c = 0, d = b.indexOf('.') + 1; d <= b.length; d++)
        void 0 === b[d] && a > c && (b += '0'), c++;
      return b;
    });
  var cb,
    db,
    ...
    gb = function() {
      for (
        ...
        var l = $(f[k]),
          m = l
            .find('[data-ibcl-id="item_quantity"]:visible')
            .text()
            .getNumber();
        '' ===
          l
            .find('[data-ibcl-id="item_quantity"]:visible')
            .text()
            .trim() && (m = a.default_quantity.getNumber());
        var n =
            l
              .find('[data-ibcl-id="item_price"]:visible')
              .text()
              .getNumber() || a.default_price,
          o =
            l
              .find('[data-ibcl-id="item_discount"]:visible')
              .text()
              .getNumber() || a.default_discount.getNumber(),
          p =
            l
              .find('[data-ibcl-id="item_tax"]:visible')
              .text()
              .getNumber() || a.default_tax.getNumber();
        isNaN(parseFloat(l.find('[data-ibcl-id="item_tax"]:visible').text())) &&
          (p = null),
          isNaN(
            l
              .find('[data-ibcl-id="item_price"]')
              .text()
              .getNumber()
          )
            ? l
            ...
            : (l
                .find('[data-ibcl-id="item_price"]')
                .removeClass('add_currency_left add_currency_right')
                .attr('data-currency', tb)
                .data('currency', tb),
              JSON.parse(vb) &&
                l
                  .find('[data-ibcl-id="item_price"]')
                  .addClass(
                    'left' == ub ? 'add_currency_left' : 'add_currency_right'
                  )),
          isNaN(
            l
              .find('[data-ibcl-id="item_discount"]')
              .text()
              .getNumber()
          )
            ? l
                .find('[data-ibcl-id="item_discount"]')
                .removeClass('ib_item_percentage')
                .find('br, p, div')
                .remove()
            : l
                .find('[data-ibcl-id="item_discount"]')
                .addClass('ib_item_percentage')
                .find('br, p, div')
                .remove(),
          isNaN(
            l
              .find('[data-ibcl-id="item_tax"]')
              .text()
              .getNumber()
          )
            ? l
        ...
        (b = $('[data-ibcl-id="amount_paid"]')
          .text()
          .getNumber()),
          (d = $('[data-ibcl-id="amount_due"]')
            .text()
            .getNumber());
        var r = 0,
          s = 0;
        if (
          (isNaN(m) || isNaN(n) || (r = m * n),
          isNaN(o) || (r -= Math.abs(r * (o / 100))),
          (g += r),
          isNaN(p) || (s = p / 100),
          (i = r * s),
          (h += i),
        ...
        q
          .html(r.toFixed(2).getFormatedNumber())
          .removeClass('add_currency_left add_currency_right')
          .attr('data-currency', tb)
          .data('currency', tb),
          JSON.parse(vb) &&
      ...
      for (e = 0; e < j.length; e++)
        (w = Object.keys(j[e])[0]),
          (v = $('[data-iterate="tax"]:visible')
            .find('[data-ib-value="' + w.getFormatedNumber() + '"]')
            .closest('[data-iterate="tax"]')),
          v.length && x.push($(v).clone());
      for (
        $('[data-iterate="tax"]:visible').remove(), e = 0;
        e < j.length;
        e++
      ) {
        w = Object.keys(j[e])[0];
        ...
        if (y > -1) $('[data-iterate="tax"]:hidden').before(x[y]);
          ...
          var z = v.find('[data-ibcl-id="tax_name"]'),
            A = z.text().trim(),
            B = A.lastIndexOf(':');
          (-1 == B || B != A.length - 1) && (B = A.length),
            z.html(
              A.substring(0, B) + ' ' + (e + 1) + A.substring(B, A.length)
            ),
            v
              .find('[data-ibcl-id="tax_value"]')
              .attr('data-ib-value', Object.keys(j[e])[0].getFormatedNumber()),
            $('[data-iterate="tax"]:hidden').before(v);
        }
      }
      for (e = 0; e < j.length; e++)
        (w = Object.keys(j[e])[0]),
          (v = JSON.parse(vb)
            ? 'left' == ub
              ? tb + j[e][w].toFixed(2).getFormatedNumber()
              : j[e][w].toFixed(2).getFormatedNumber() + tb
            : j[e][w].toFixed(2).getFormatedNumber()),
          $('[data-iterate="tax"]')
            .find('[data-ib-value="' + w.getFormatedNumber() + '"]')
            .html(v);
      var C = g + h;
      isNaN(b) &&
        ((b = 0),
        $('[data-ibcl-id="amount_paid"]').html(
          b.toFixed(2).getFormatedNumber()
        )),
        $('[data-ibcl-id="amount_paid"]')
          ...
          .data('currency', tb),
        JSON.parse(vb) &&
          $('[data-ibcl-id="amount_paid"]').addClass(
            'left' == ub ? 'add_currency_left' : 'add_currency_right'
          ),
        isNaN(d) && (d = 0),
        (d = C - b),
        JSON.parse(vb)
          ? ((g =
              'left' == ub
                ? tb + g.toFixed(2).getFormatedNumber()
                : g.toFixed(2).getFormatedNumber() + tb),
            (C =
              'left' == ub
                ? tb + C.toFixed(2).getFormatedNumber()
                : C.toFixed(2).getFormatedNumber() + tb),
            (d =
              'left' == ub
                ? tb + d.toFixed(2).getFormatedNumber()
                : d.toFixed(2).getFormatedNumber() + tb))
          : ((g = g.toFixed(2).getFormatedNumber()),
            (C = C.toFixed(2).getFormatedNumber()),
            (d = d.toFixed(2).getFormatedNumber())),
        $('[data-ibcl-id="amount_subtotal"]').html(g),
        $('[data-ibcl-id="amount_total"]').html(C),
        $('[data-ibcl-id="amount_due"]').html(d),
        E();
    },
    hb = function() {
      for (
        var a = $('[data-ibcl-id="item_row_number"]'), b = 0;
        b < a.length;
        b++
      )
        $(a[b]).append(
          $('<ib-span data-row-number="item_row_number"></ib-span>')
        );
      ib();
    },
    ib = function() {
      for (
        var a = $('[data-row-number="item_row_number"]'), b = 0;
        b < a.length;
        b++
      )
        $(a[b]).html(b + 1);
    ...
    jb = function() {
      if (JSON.parse(a.load_items)) {
        ...
        for (var c = 0; c < a.items.length; c++)
          $(b[c])
            .find('[data-ibcl-id="item_description"]')
            .html(a.items[c].item_description),
            $(b[c])
              .find('[data-ibcl-id="item_quantity"]')
              .html(a.items[c].item_quantity),
            $(b[c])
              .find('[data-ibcl-id="item_price"]')
              .html(a.items[c].item_price),
            $(b[c])
              .find('[data-ibcl-id="item_discount"]')
              .html(a.items[c].item_discount.replace(/%/g, '')),
            $(b[c])
              .find('[data-ibcl-id="item_tax"]')
              .html(a.items[c].item_tax.replace(/%/g, ''));
      }
    },
    kb = function() {
      var a =
        '<ib-span class="ib_row_commands" style="height:' +
        $('[data-iterate="item"]').height() +
        'px;"><ib-span class="ib_commands"><ib-span class="ib_add" title="' +
        F[Ib].insert_row +
        '"><i class="fa fa-plus"></i></ib-span><ib-span class="ib_delete" title="' +
        F[Ib].remove_row +
        '"><i class="fa fa-minus"></i></ib-span><ib-span class="ib_move" title="' +
        F[Ib].drag_to_reorder +
        '"><i class="fa fa-sort"></i></ib-span></ib-span></ib-span>';
      ...
      $('.ib_add').click(function(a) {
        ...
        $('[data-iterate="item"]').hover(
          function() {
            $(this)
              .find('.ib_row_commands .ib_commands')
              .css('display', 'block');
          },
          function() {
            $(this)
          ...
          switch ($(this).data('ibcl-id')) {
            case 'net_term':
              ...
              ($(this).text().length >= 3 &&
                ...
                ? a.preventDefault()
                : ($('[data-ibcl-id="net_term"], [data-ibcl-id="due_date"]')
                    .removeClass('ib_stop_animate')
                    .addClass('ib_highlight_bg'),
                  setTimeout(function() {
                    $(
                      '[data-ibcl-id="net_term"], [data-ibcl-id="due_date"]'
                    ).removeClass('ib_highlight_bg');
                  }, 10));
              break;
            case 'item_quantity':
            case 'item_price':
            ...
            case 'amount_paid':
              if ('-' == c) {
                if (
                  ...
                  (b = window.getSelection().extentOffset + 1),
                    $(this).text(
                      '-' +
                        $(this)
                          .text()
    ...
    mb = function(a, c) {
      c.stopPropagation(),
        c.preventDefault(),
        $(a).hasClass('ib_add_new_row_link')
          ? $(a)
              .closest('.ib_bottom_row_commands')
              .before($(b).clone())
          : $(a)
              .closest('[data-iterate="item"]')
              .before($(b).clone()),
        ib(),
        kb(),
        $('.ib_show_hide_columns > ib-span > input:checkbox').each(function(a) {
          $(
            '.ib_show_hide_columns > ib-span > input:checkbox:nth(' + a + ')'
          ).change();
        }),
        E(),
        gb();
    ...
    ob = function() {
      (cb = new Date()),
        (db = new Date(
          new Date().setDate(
            new Date().getDate() + parseInt(a['{net_term}'].default_text)
          )
        )),
        (eb = pb(cb, a.date_format)),
        (fb = pb(db, a.date_format)),
        (a['{issue_date}'].default_text = eb),
        (a['{due_date}'].default_text = fb);
    },
    pb = function(a, b) {
      var c = b.match(/[.\/\-\s].*?/),
        d = b.split(/\W+/);
    ...
    qb = function() {
      for (
        ...
        b +=
          '<ib-div><input type="radio" id="ib_date_format_radio' +
          d +
          '" name="ib_date_format_choice" value="' +
          c[d] +
          ...
          c[d] +
          '</label></ib-div>';
      var e = $('<ib-div class="ib_date_format">' + b + '</ib-div>').hover(
        function() {
          $(this).show();
        },
        function() {
      ...
      $(document.body).after(e),
        $('[data-ibcl-id="issue_date"]')
          .datepicker({ format: a.date_format })
          .data('datepicker'),
        ...
        $('[data-ibcl-id="issue_date"], [data-ibcl-id="due_date"]')
          .on('changeDate', function(b) {
            if ('days' == b.viewMode) {
              ...
              isNaN(parseInt($('[data-ibcl-id="net_term"]').text())) ||
                (c = parseInt($('[data-ibcl-id="net_term"]').text())),
                'issue_date' == $(this).data('ibcl-id')
                  ? ((cb = new Date(b.date)),
                    JSON.parse(a.auto_calculate_dates) &&
                      ((db = new Date(b.date.setDate(cb.getDate() + c))),
                      $('[data-ibcl-id="due_date"]')
                        .datepicker('setValue', db)
                        .text($('[data-ibcl-id="due_date"]').data('date')),
                      $('[data-ibcl-id="issue_date"]')
                        .datepicker('setValue', cb)
                        .text($('[data-ibcl-id="issue_date"]').data('date')),
                      $(
                        '[data-ibcl-id="issue_date"], [data-ibcl-id="due_date"]'
                      )
                        .removeClass('ib_stop_animate')
                  ...
                  : 'due_date' == $(this).data('ibcl-id') &&
                    ((db = new Date(b.date)),
                    JSON.parse(a.auto_calculate_dates) &&
                      ((c = Math.ceil(
                        Math.abs((db.getTime() - cb.getTime()) / 864e5)
                      )),
                      $('[data-ibcl-id="net_term"]').text(c),
                      $('[data-ibcl-id="net_term"], [data-ibcl-id="due_date"]')
                        .removeClass('ib_stop_animate')
                        .addClass('ib_highlight_bg'),
                      setTimeout(function() {
        ...
        e
          ...
          .val([a.date_format])
          .change(function() {
            (a.date_format = $(this).val()),
              $(
                '[data-ibcl-id="issue_date"], [data-ibcl-id="due_date"]'
              ).datepicker('setFormat', a.date_format),
              $('[data-ibcl-id="issue_date"]')
                .datepicker('setValue', cb)
                .text($('[data-ibcl-id="issue_date"]').data('date')),
              $('[data-ibcl-id="due_date"]')
    ...
    rb = function() {
      ...
      isNaN(parseInt($('[data-ibcl-id="net_term"]').text())) ||
        (b = parseInt($('[data-ibcl-id="net_term"]').text())),
        JSON.parse(a.auto_calculate_dates) &&
          ((db = new Date(new Date(cb).setDate(cb.getDate() + b))),
          $('[data-ibcl-id="due_date"]')
            .datepicker('setValue', db)
            .text($('[data-ibcl-id="due_date"]').data('date')));
    },
    ...
    Ab = function() {
      $.each(zb.split(';'), function(a, b) {
        var c = b.split(',');
        sb.push({ name: c[0], symbol: c[1], code: c[2], priority: c[3] });
      });
    },
    Bb = function() {
      var a = $(
        '<ib-span class="ib_number_settings"><table><tr><td><input type="radio" id="ib_currency_left" name="ib_currency" value="left" checked /><label for="ib_currency_left" title="' +
          F[Ib].currency_left +
          '">$100</label></td><td><input type="radio" id="ib_number_format_1" name="ib_number_format" value="0,000.00" checked /><label for="ib_number_format_1">1,234.56</label></td></tr><tr><td><input type="radio" id="ib_currency_right" name="ib_currency" value="right" /><label for="ib_currency_right" title="' +
          F[Ib].currency_right +
          '">100$</label></td><td><input type="radio" id="ib_number_format_3" name="ib_number_format" value="0 000.00" /><label for="ib_number_format_3">1&#8239;234.56</label></td></tr><tr><td></td><td><input type="radio" id="ib_number_format_2" name="ib_number_format" value="0000.00" /><label for="ib_number_format_2">1234.56</label></td></tr><tr><td></td><td><input type="radio" id="ib_number_format_4" name="ib_number_format" value="0.000,00" /><label for="ib_number_format_4">1.234,56</label></td></tr><tr><td></td><td><input type="radio" id="ib_number_format_6" name="ib_number_format" value="0 000,00" /><label for="ib_number_format_6">1&#8239;234,56</label></td></tr><tr><td></td><td><input type="radio" id="ib_number_format_5" name="ib_number_format" value="0000,00" /><label for="ib_number_format_5">1234,56</label></td></tr><tr><td colspan="2" class="ib_show_currency"><input type="checkbox" id="ib_show_currency" name="ib_show_currency" /><label for="ib_show_currency" title="Checking this will show the currency symbol on all amounts on the invoice">Show currency symbol</label></td></tr></table></ib-span>'
      ).hover(
        function() {
          $(this).show();
        },
      ...
      $(document.body).after(a),
        $('[data-ibcl-id="currency"]')
          .typeahead({
            source: function(a, b) {
              (ib_currencies_combo = []),
                $.each(sb, function(a, b) {
                  ib_currencies_combo.push(
                    "<ib-span data-code='" +
                      b.code +
                      "' data-symbol='" +
                      b.symbol +
                      '\' class="ib_currencies_item"><ib-span>' +
                      b.code +
                      '</ib-span><ib-span>' +
                      b.symbol +
                      '</ib-span><ib-span>' +
            ...
            matcher: function(a) {
              return -1 !=
                $(a)
                  .text()
                  .toLowerCase()
                  .indexOf(this.query.trim().toLowerCase())
                ? !0
                : void 0;
            },
            sorter: function(a) {
          ...
          .blur(function() {
            ...
            (tb = ''),
              a.text(b),
              $.each(sb, function(c, d) {
                return d.code.toUpperCase() == b
                  ? (a.text(d.code), (tb = d.symbol), void gb())
                  : void 0;
              });
          })
          .hover(
        ...
        $('[name="ib_currency"][value="' + ub + '"]').attr(
          'checked',
          'checked'
        ),
        JSON.parse(vb) &&
          $('[name="ib_show_currency"]').attr('checked', 'checked'),
        $('[name="ib_number_format"][value="' + wb + '"]').attr(
          'checked',
          'checked'
        ),
        $('[name="ib_currency"]').change(function() {
          (ub = $(this).val()), gb();
        }),
        ...
        $('[name="ib_number_format"]').change(function() {
          ...
          for (var a = $('[data-iterate="item"]'), b = 0; b < a.length; b++) {
            var c = $(a[b]);
            c.find('[data-ibcl-id="item_quantity"]').text(
              c
                .find('[data-ibcl-id="item_quantity"]')
                .text()
                .replace(/[.,]/g, xb)
            ),
              c.find('[data-ibcl-id="item_price"]').text(
                c
                  .find('[data-ibcl-id="item_price"]')
                  .text()
                  .replace(/[.,]/g, xb)
              ),
              c.find('[data-ibcl-id="item_discount"]').text(
                c
                  .find('[data-ibcl-id="item_discount"]')
                  .text()
                  .replace(/[.,]/g, xb)
              ),
              c.find('[data-ibcl-id="item_tax"]').text(
                c
                  .find('[data-ibcl-id="item_tax"]')
                  .text()
                  .replace(/[.,]/g, xb)
    ...
    Cb = function() {
      ...
      (b.hash = $('meta[name="template-hash"]').attr('content') || b.hash),
        (b.type = $('meta[name="document-type"]').attr('content') || b.type),
        $('[data-logo="company_logo"]').is(':visible') &&
          (b.company_logo =
            $('[data-logo="company_logo"]').attr('src') || b.company_logo),
        $('[data-ibcl-id]').each(function(a, c) {
          var d = $(c);
          b[d.data('ibcl-id')] = B(A(d.html())) || b[d.data('ibcl-id')];
        }),
        b.net_term ||
          (b.net_term = Math.floor(
            Math.abs((db.getTime() - cb.getTime()) / 864e5)
          )),
        $('.ib_show_hide_columns > ib-span > input:checkbox').each(function(
          a,
          c
        ) {
          $(c).is(':checked') && b.items_columns.push($(c).val());
        }),
        delete b.item_row_number,
        delete b.item_description,
        delete b.item_quantity,
        delete b.item_price,
        delete b.item_discount,
        delete b.item_tax,
        delete b.item_line_total,
        $('[data-iterate="item"]').each(function(a, c) {
          var d = {};
          $(c)
            .find('*')
            .each(function(a, b) {
              ...
              c.data('ibcl-id') &&
                -1 !=
                  [
                    ...
                    'item_discount',
                    'item_line_total'
                  ].indexOf(c.data('ibcl-id')) &&
                (!c.data('ibcl-id') &&
                  y() &&
                  (c = c.find('.ibcl_ie_contenteditable')),
                (d[c.data('ibcl-id')] = B(A(c.html()))));
            }),
            (d.item_row_number = $(d.item_row_number).text()),
            (d.item_quantity = d.item_quantity.toValidNumberString()),
            (d.item_price = d.item_price.toValidNumberString()),
            (d.item_tax_percentage = d.item_tax.toValidNumberString()),
            (d.item_tax = bb(d.item_tax.toValidNumberString())),
            (d.item_discount = d.item_discount.toValidNumberString()),
            (d.item_line_total = d.item_line_total.toValidNumberString()),
            b.items.push(d);
        }),
        delete b.tax_name,
        delete b.tax_value,
        $('[data-iterate="tax"]:visible').each(function(a, c) {
          var d = {};
          $(c)
            .find('*')
            .each(function(a, b) {
              var c = $(b);
              c.data('ibcl-id') &&
                -1 != ['tax_name', 'tax_value'].indexOf(c.data('ibcl-id')) &&
                (!c.data('ibcl-id') &&
                  y() &&
                  (c = c.find('.ibcl_ie_contenteditable')),
                (d[c.data('ibcl-id')] = B(A(c.html()))),
                c.attr('data-ib-value') &&
                  (d.tax_percentage = c
                    .attr('data-ib-value')
                    .toValidNumberString()));
            }),
            (d.tax_value = d.tax_value.toValidNumberString()),
            b.taxes.push(d);
        }),
        (b.amount_subtotal = b.amount_subtotal.toValidNumberString()),
        (b.amount_total = b.amount_total.toValidNumberString()),
        (b.amount_paid = b.amount_paid.toValidNumberString()),
        (b.amount_due = b.amount_due.toValidNumberString()),
        (b.date_format = a.date_format),
        (b.currency_code = b.currency),
        (b.currency_symbol = tb),
        delete b.currency,
        (b.currency_position = $(
          '.ib_number_settings input[name="ib_currency"]:checked'
        ).val()),
        (b.show_currency = $(
          '.ib_number_settings input[name="ib_show_currency"]'
        ).is(':checked')),
        (b.number_format = $(
          '.ib_number_settings input[name="ib_number_format"]:checked'
        ).val());
      for (var c in b)
        /document_custom_[a-zA-Z0-9_]+/.test(c)
          ? (b.document_custom.push({
              name: c.replace(/document_custom_([a-zA-Z0-9_]+)/, '$1'),
              type: 'constant',
              value: b[c]
            }),
            delete b[c])
          : /client_custom_[a-zA-Z0-9_]+/.test(c) &&
            (b.client_custom.push({
    ...
    Eb = function() {
      if (!Db) {
        ...
        var a = $('<div />')
          ...
          .html()
          .replace(/"/gi, '&quot;');
        (g += f + '&utm_term=' + encodeURIComponent(document.title)),
          $(
            '<form id="ib_save_tamplate_form" style="display:none !important;" action="' +
              g +
              '" method="POST" />'
          )
            .append(
              $('<input type="hidden" name="invoice_data" value="' + a + '" />')
            )
    ...
    Fb = function() {
      var b,
        c = ib_multiline
          .stripIndent(ib_raw_data)
          .replace(/\\\//g, '/')
          .replace(/'/g, "\\'")
          .replace(/\r\n/g, '[crlf]'),
        d = Cb();
      (c = c.replace('|item_row_number|', a['{item_row_number}'].default_text)),
        (c = c.replace(
          '|item_description|',
          a['{item_description}'].default_text
        )),
        (c = c.replace('|item_quantity|', a['{item_quantity}'].default_text)),
        (c = c.replace('|item_price|', a['{item_price}'].default_text)),
        (c = c.replace('|item_discount|', a['{item_discount}'].default_text)),
        (c = c.replace('|item_tax|', a['{item_tax}'].default_text)),
        (c = c.replace(
          '|item_line_total|',
          a['{item_line_total}'].default_text
        )),
        (c = c.replace('|tax_name|', a['{tax_name}'].default_text)),
        (c = c.replace('|tax_value|', a['{tax_value}'].default_text)),
        (c = c.replace('|amount_total|', a['{amount_total}'].default_text)),
        (c = c.replace('|amount_due|', a['{amount_due}'].default_text)),
        (c = c.replace('|default_quantity|', a.default_quantity)),
        (c = c.replace('|default_price|', a.default_price)),
        (c = c.replace('|default_discount|', a.default_discount)),
        (c = c.replace('|default_tax|', a.default_tax)),
        (c = c.replace('|default_number_rows|', a.default_number_rows)),
        (c = c.replace('|auto_calculate_dates|', a.auto_calculate_dates)),
        (c = c.replace('|load_items|', a.load_items)),
        (c = c.replace('|invoicebus_fineprint|', a.invoicebus_fineprint)),
        (c = c.replace('|lang|', Ib));
      for (var e in d) {
        var f = '|' + e + '|',
        ...
        switch (e) {
          ...
          case 'items':
            ...
            for (b = 0; b < h.length; b++)
              g +=
                (h[b].item_description || '')
                  .toString()
                  .replace(/\n/g, '<br />') +
                '@||@' +
                (h[b].item_quantity || '').toString().replace(/\n/g, '<br />') +
                '@||@' +
                (h[b].item_price || '').toString().replace(/\n/g, '<br />') +
                '@||@' +
                (h[b].item_discount || '').toString().replace(/\n/g, '<br />') +
                '@||@' +
                (h[b].item_tax_percentage || '')
                  .toString()
                  .replace(/\n/g, '<br />') +
                '\r\n';
            c = c.replace(f, g);
          ...
          case 'client_custom':
            ...
            for (b = 0; b < i.length; b++)
              g +=
                (i[b].name || '').toString().replace(/\n/g, '<br />') +
                '@||@' +
                (i[b].value || '').toString().replace(/\n/g, '<br />') +
                '\r\n';
            c = c.replace(f, g);
            break;
          default:
    ...
    Hb = function(a, b) {
      for (
        var c = b || window.location.search.substring(1),
          d = c.split('&'),
          e = 0;
        e < d.length;
        e++
  ...
  (Lb.onerror = function() {
    ...
    Kb &&
      ...
      document.body.appendChild(Lb)),
    (Lb = document.createElement('script')),
    (Lb.src = i + 'docs/raw-data/raw-data-' + (Ib || 'en') + '.js'),
    document.body.appendChild(Lb),
    q(function() {
      t();
    });
...
var ib_TableDnD = function(a) {
    ...
    (this.dragObject = null),
      ...
      (this.oldY = 0),
      (this.init = function() {
        for (var a = $('[data-iterate="item"]'), c = 0; c < a.length; c++)
          this.makeDraggable(a[c]);
        (document.onmousemove = function(a) {
          if (b && b.dragObject) {
            ...
            if (d != b.oldY) {
              var e = d > b.oldY;
              (b.oldY = d),
                $(b.dragObject).addClass('ib_dragrow'),
                (document.body.style.cursor = 'move');
              var f = b.findDropTargetRow(d);
              f &&
                (e && b.dragObject != f
                  ? b.dragObject.parentNode.insertBefore(
                      b.dragObject,
                      f.nextSibling
                    )
                  : e ||
                    b.dragObject == f ||
                    b.dragObject.parentNode.insertBefore(b.dragObject, f));
            }
            return !1;
          }
        }),
          (document.onmouseup = function() {
            if (b && b.dragObject) {
              var a = b.dragObject;
              $(b.dragObject).removeClass('ib_dragrow'),
                (b.dragObject = null),
                b.onDrop(a),
                (b = null);
            }
    ...
    (this.mouseCoords = function(a) {
      return a.pageX || a.pageY
        ? { x: a.pageX, y: a.pageY }
        : { x: a.clientX + c()[0], y: a.clientY + c()[1] };
    }),
    ...
    (this.makeDraggable = function(a) {
      if (a) {
        ...
        $(a)
          ...
          .on('mousedown', function(e) {
            var f = d(e);
            return 'INPUT' == f.tagName ||
              'SELECT' == f.tagName ||
              'TEXTAREA' == f.tagName
              ? !0
              : ((b = c),
                (c.dragObject = a),
                (c.mouseOffset = c.getMouseOffset(a, e)),
                !1);
          }),
          $(a)
            .find('.ib_move')
      ...
      (this.findDropTargetRow = function(a) {
        for (var b = $('[data-iterate="item"]'), c = 0; c < b.length; c++) {
          ...
          if (
            (0 === d.offsetHeight &&
              ((e = $(d.firstChild).offset().top),
              (f = parseInt(d.firstChild.offsetHeight))),
            a > e - f && e + f > a)
          )
            return d;
        }
  ...
  ib_loadBootstrapDatepicker = function() {
    var a = function(a, c) {
      if (
        ((this.element = $(a)),
        (this.format = b.parseFormat(
          c.format || this.element.data('date-format') || 'mm/dd/yyyy'
        )),
        (this.picker = $(b.template)
          .appendTo('body')
        ...
        (this.minViewMode =
          c.minViewMode || this.element.data('date-minviewmode') || 0),
      ...
      if (
        ((this.viewMode =
          c.viewMode || this.element.data('date-viewmode') || 0),
      ...
      (this.startViewMode = this.viewMode),
        (this.weekStart =
          c.weekStart || this.element.data('date-weekstart') || 0),
    ...
    (a.prototype = {
      ...
      set: function() {
        ...
        this.isInput
          ...
          : (this.component && this.element.find('input').prop('value', a),
            this.element.data('date', a));
      },
      setValue: function(a) {
        (this.date =
          'string' == typeof a ? b.parseDate(a, this.format) : new Date(a)),
          this.set(),
      ...
      setFormat: function(a) {
        ...
        this.isInput
          ? this.element.prop('value', c)
          : (this.component && this.element.find('input').prop('value', c),
            this.element.data('date', c)),
          this.set(),
          (this.viewDate = new Date(
            this.date.getFullYear(),
            this.date.getMonth(),
      ...
      fillDow: function() {
        for (var a = this.weekStart, c = '<tr>'; a < this.weekStart + 7; )
          c += '<th class="dow">' + b.dates.daysMin[a++ % 7] + '</th>';
        (c += '</tr>'), this.picker.find('.datepicker-days thead').append(c);
      },
      fillMonths: function() {
        for (var a = '', c = 0; 12 > c; )
          a +=
            '<ib-span class="month">' + b.dates.monthsShort[c++] + '</ib-span>';
      ...
      fill: function() {
        ...
        for (var i, j, k, l = []; f.valueOf() < h; )
          f.getDay() === this.weekStart && l.push('<tr>'),
            (i = this.onRender(f)),
            (j = f.getFullYear()),
            (k = f.getMonth()),
            (d > k && j === c) || c > j
              ? (i += ' old')
              : ((k > d && j === c) || j > c) && (i += ' new'),
            f.valueOf() === e && (i += ' active'),
            l.push('<td class="day ' + i + '">' + f.getDate() + '</td>'),
            f.getDay() === this.weekEnd && l.push('</tr>'),
        ...
        var m = this.date.getFullYear(),
          n = this.picker
            ...
            .find('ib-span')
            .removeClass('active');
        m === c && n.eq(this.date.getMonth()).addClass('active'),
          (l = ''),
          ...
          switch (c[0].nodeName.toLowerCase()) {
            case 'th':
              switch (c[0].className) {
                ...
                case 'prev':
                case 'next':
                  this.viewDate['set' + b.modes[this.viewMode].navFnc].call(
                    this.viewDate,
                    this.viewDate['get' + b.modes[this.viewMode].navFnc].call(
                      this.viewDate
                    ) +
                      b.modes[this.viewMode].navStep *
                        ('prev' === c[0].className ? -1 : 1)
                  ),
                    this.fill(),
                    this.set();
              }
            ...
            case 'td':
              c.is('.day') &&
                !c.is('.disabled') &&
                ((d = parseInt(c.text(), 10) || 1),
                (e = this.viewDate.getMonth()),
                c.is('.old') ? (e -= 1) : c.is('.new') && (e += 1),
                (f = this.viewDate.getFullYear()),
                (this.date = new Date(f, e, d, 0, 0, 0, 0)),
                (this.viewDate = new Date(f, e, Math.min(28, d), 0, 0, 0, 0)),
                this.fill(),
                this.set(),
                this.element.trigger({
                  type: 'changeDate',
      ...
      showMode: function(a) {
        a &&
          ...
          this.picker
            .find('>div')
            .hide()
            .filter('.datepicker-' + b.modes[this.viewMode].clsName)
            .show();
      }
    }),
      ($.fn.datepicker = function(b, c) {
        return this.each(function() {
          ...
          e ||
            d.data(
              'datepicker',
              (e = new a(this, $.extend({}, $.fn.datepicker.defaults, f)))
            ),
            'string' == typeof b && e[b](c);
        });
      }),
      ...
      parseDate: function(a, b) {
        ...
        if (
          ...
          for (
            ...
            switch (((c = parseInt(d[h], 10) || 1), b.parts[h])) {
              case 'dd':
              case 'd':
                (f = c), a.setDate(c);
                break;
  ...
  ib_loadBootstrapTypeahead = function() {
    ...
    var a = function(a, b) {
      (this.$element = $(a)),
        (this.options = $.extend({}, $.fn.typeahead.defaults, b)),
        ...
        (this.delay =
          'number' == typeof this.options.delay ? this.options.delay : 250),
    ...
    a.prototype = {
      ...
      select: function() {
        ...
        return (
          (this.autoSelect || a) &&
            this.$element.text(this.updater(a)).change(),
          this.hide()
        );
      },
      updater: function(a) {
      ...
      show: function() {
        ...
        return (
          ...
          this.$menu
            .appendTo(document.body)
            .css({ top: b.top + b.height + a, left: b.left })
            .show(),
          (this.shown = !0),
          this
        );
        ...
        return (
          ...
          a.length
            ? 'all' == this.options.items
              ? this.render(a).show()
              : this.render(a.slice(0, this.options.items)).show()
            : this.shown
            ? this.hide()
            : this
        );
      ...
      render: function(a) {
        ...
        return (
          (a = $(a).map(function(a, c) {
            return (
              (a = $(b.options.item).data('value', c)),
              a.find('a').html(b.highlighter(c)),
              a[0]
            );
          })),
          this.autoSelect && a.first().addClass('active'),
          this.$menu.html(a),
          this
        );
      },
      ...
      keydown: function(a) {
        (this.suppressKeyPressRepeat = ~$.inArray(a.keyCode, [
          40,
          38,
          9,
          13,
          ...
          this.shown || 40 != a.keyCode ? this.move(a) : this.lookup('');
      },
      keypress: function(a) {
      ...
      focus: function() {
        this.focused ||
          ((this.focused = !0),
          ((0 === this.options.minLength && !this.$element.text()) ||
            this.options.showHintOnFocus) &&
            this.lookup());
      },
      blur: function() {
    ...
    ($.fn.typeahead = function(b) {
      ...
      return this.each(function() {
        var d = $(this),
          e = d.data('typeahead'),
          f = 'object' == typeof b && b;
        e || d.data('typeahead', (e = new a(this, f))),
          'string' == typeof b &&
            (c.length > 1
...
var ib_parseData = function(a) {
  ...
  for (c = a.split('\n'), d = 0; d < c.length; d++)
    if (((f = c[d].trim()), '#' != f)) {
      ...
      if (
        ('[default_columns]' == f &&
          (i.default_columns = i.default_columns.split(',').map(b)),
        '[items]' == f)
      ) {
      ...
      if ('[document_custom]' == f)
        for (e = d + 1, f = c[e].replace(/\r|\n/g, ''); '' !== f; )
          (g = f.split('@||@')),
            (i['{document_custom_' + g[0] + '}'] = g[1]),
            e++,
            (f = c[e].trim());
      if ('[client_custom]' == f)
        for (e = d + 1, f = c[e].replace(/\r|\n/g, ''); '' !== f; )
          (g = f.split('@||@')),
            (i['{client_custom_' + g[0] + '}'] = g[1]),
            e++,
            (f = c[e].trim());
    }
